...
class TransferModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        nb = opt.batchSize
        size = opt.fineSize
        self.input_P1_set = self.Tensor(nb, opt.P_input_nc, size, size // 2)
        self.input_BP1_set = self.Tensor(nb, opt.BP_input_nc, size, size // 2)
        self.input_P2_set = self.Tensor(nb, opt.P_input_nc, size, size // 2)
        self.input_BP2_set = self.Tensor(nb, opt.BP_input_nc, size, size // 2)
        ...
        if self.isTrain:
            ...
            if opt.L1_type == 'origin':
                ...
                raise Exception('Unsupportted type of L1!')
    ...
    def set_input(self, input):
        input_P1, input_BP1 = input['P1'].cuda(), input['BP1'].cuda()
        input_P2, input_BP2 = input['P2'].cuda(), input['BP2'].cuda()

        self.input_P1_set = input_P1
        self.input_BP1_set = input_BP1
        self.input_P2_set = input_P2
        self.input_BP2_set = input_BP2
    ...
    def forward(self):
        self.input_P1 = self.input_P1_set
        self.input_BP1 = self.input_BP1_set

        self.input_P2 = self.input_P2_set
        self.input_BP2 = self.input_BP2_set
